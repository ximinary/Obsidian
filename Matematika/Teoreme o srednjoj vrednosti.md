...
[[analiza1_2_lagranz_p2.png|Posledica 2]]. $I$ je interval ($\mathring I$ je otvoreni deo intervala). $f:I\to\mathbb{R},\ f\,\mathcal{C}\,I,\ f\,\mathcal{D}\,\mathring I$. Tada
...
[[analiza1_2_lagranz_p3.png|Posledica 3]]. $\exists \lim\limits_{ x \to x_{0}^{+/-} }f'(x) = L\in\overline{\mathbb{R}} \ \ \Rightarrow\ \ f'_{+/-}(x_{0})=L$ ^c133de

[[analiza1_2_kosi.png|Teorema]] (Košijeva o srednjoj vrednosti).
