...
$\#(f)=n$ $\quad$ — dužina operacije

- $n=0$, **nularna operacija** je $f:\ A^{0}\to A$
  podrazumeva se izbor **konstante** iz skupa $A$
$\:$
- $n=1$, **unarna operacija** je $f:\ A\to A$
  $f(a),\quad a\in\mathbb{N}$
$\:$
- $n=2$, **binarna operacija** je $f:\ A^{2}\to A$
$f(a,\,b)\:$ ili češće $\:a\,f\,b$, $\quad a,\,b\in\mathbb{N}$
$\:$
$f$ je komutativna ako $\forall a,\,b\in A\quad a\,f\,b=b\,f\,a$
$f$ je asocijativna ako $\forall a,\,b,\,c\in A\quad a\,f\,(b\,f\,c)=(a\,f\,b)\,f\,c$
