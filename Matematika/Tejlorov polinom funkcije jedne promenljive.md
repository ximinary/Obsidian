...
[[analiza1_2_lagranzovOblikOst.png|Teorema]] (Lagranžov oblik ostatka). $\begin{align}f\,\mathcal{C}^{n+1}\,\mathrm{O}(x_{0})\ \ \Rightarrow\ \ R_{n}(x,\,x_{0};\,f)=\frac{f^{(n+1)}(\xi)}{(n+1)!}(x-x_{0})^{n+1}\end{align}$ 
