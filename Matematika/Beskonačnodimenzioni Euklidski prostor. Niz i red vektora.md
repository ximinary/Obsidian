...
Ako $\exists\lim\limits_{ n \to \infty }s_{n}=s\in V$, onda red $\begin{align}\sum\limits_{k=1}^{\infty}u_{k}\end{align}$ **konvergira** i jednak je $s$, inače **divergira**. 
...
**Def**. $\forall n \in \mathbb{N}\quad v_{n}= \langle v,\ e_{n}\rangle$ zovu se **Furijeovi koeficijenti** vektora $v$ u odnosu na ortonormirani niz $e_{n}$. 
...
___
**Teorema** (Beselova nejednakost). $\forall v\in V$. $(e_{n})$ je ortonormirani niz vektora u prostoru $V$. Tada $\begin{align}\langle v,\ v\rangle\geqslant \sum\limits_{n=1}^{\infty} \langle v,\ e_{n}\rangle^{2}\end{align}$ $\quad$ (i red konvergira). ^36e255
...
3. $\begin{align}\forall v\in V\quad \sum\limits_{n=1}^{\infty}\langle v,\,e_{n}\rangle^{2}=\langle v,\,v\rangle\end{align}$ $\quad$ (Parsevalova jednakost) ^927ed4

Ako je tačan jedan od iskaza (a samim tim i sve) onda je niz $(e_{n})$ **potpun ortonormiran niz**.
